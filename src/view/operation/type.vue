  ...
  <div>
          ...
          <Form inline>
            ...
            <FormItem style="margin-bottom: 0">
              <Select v-model="searchConf.type" clearable placeholder="请选择类别" style="width:100px">
                <Option :value="1">类型标识</Option>
                <Option :value="2">类型名称</Option>
              </Select>
            </FormItem>
            <FormItem style="margin-bottom: 0">
    ...
    <Modal v-model="modalSetting.show" width="668" :styles="{top: '30px'}" @on-visible-change="doCancel">
      <p slot="header" style="color:#2d8cf0">
        ...
        <span>{{formItem.id ? '编辑' : '新增'}}能量盒类型</span>
      </p>
      <Form ref="myForm" :rules="ruleValidate" :model="formItem" :label-width="80">
        <FormItem label="分类名称" prop="name">
          <Input v-model="formItem.name" placeholder="请输入能量盒类型名称"></Input>
        </FormItem>
        <FormItem label="分类标识" prop="hash">
...
<script>
import { getList, changeStatus, add, edit, del } from '@/api/product-type'
